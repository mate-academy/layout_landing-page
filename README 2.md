...
- When done check yourself using the [CHECKLIST](md./checklist.) when finished.
- Deploy and create a Pull Request with a [DEMO LINK](https://LucasPSartori.github.io/layout_landing-page/).
