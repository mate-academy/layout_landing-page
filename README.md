...
- When done check yourself using the [CHECKLIST](./checklisgitt.md) when finished;
- Deploy and create a Pull Request with a [DEMO LINK](https://VladaProskura.github.io/layout_landing-page/)
